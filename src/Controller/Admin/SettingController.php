...
class SettingController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/edit", name="admin_setting_iedit", methods="GET|POST")
     */
    public function iedit(Request $request, Setting $setting): Response
    {
        $form = $this->createForm(SettingType::class, $setting);
        $form->handleRequest($request);


        return $this->render('include/_header.html.twig', [
            'setting' => $setting,
            'form' => $form->createView(),
        ]);
    }
